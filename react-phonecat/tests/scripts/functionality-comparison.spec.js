...
test.describe('PhoneCat Functionality Comparison', () => {
  ...
  test('Phone list page comparison', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/angular-phone-list.png' });
    ...
    // Screenshot for visual comparison
    await page.screenshot({ path: 'test-results/react-phone-list.png' });
  ...
  test('Phone detail page comparison', async ({ page }) => {
    ...
    // Screenshot for visual comparison
    await page.screenshot({ path: 'test-results/angular-phone-detail.png' });
    ...
    // Screenshot for visual comparison
    await page.screenshot({ path: 'test-results/react-phone-detail.png' });
